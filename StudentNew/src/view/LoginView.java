...
public class LoginView extends JFrame {
    ...
    public LoginView() {
        ...
        // hình ảnh cho JFame.
//        URL urllUrl = LoginView.class.getResource("/StudentNew/src/data/imageLogin/icon.png");
...
//                new ImageIcon(Toolkit.getDefaultToolkit().createImage(LoginView.class.getResource("/StudentNew/src/data/imageLogin/login.png"))));
...
//                Toolkit.getDefaultToolkit().createImage(LoginView.class.getResource("/StudentNew/src/data/imageLogin/password.png"))));
...
//                Toolkit.getDefaultToolkit().createImage(LoginView.class.getResource("/StudentNew/src/imageStudent/imageLogin/person.png"))));
